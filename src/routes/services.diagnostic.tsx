...
export const Route = createFileRoute("/services/diagnostic")({
  head: () => ({
    meta: [
      { title: "Юридическая диагностика — STATUS SVOBODY" },
      {
        name: "description",
        content:
          "Юридический и финансовый разбор ситуации: долги, доходы, имущество, кредитная история. На выходе — правовая стратегия и понятный следующий шаг.",
      },
      { property: "og:title", content: "Юридическая диагностика — STATUS SVOBODY" },
      {
        property: "og:description",
        content: "Правовой разбор вашей ситуации лично с Юлией Арминой. Стратегия и план — без обещаний и навязывания.",
      },
      { name: "twitter:title", content: "Юридическая диагностика — STATUS SVOBODY" },
      {
        name: "twitter:description",
        content: "Правовой разбор ситуации. Стратегия и план — без обещаний и навязывания.",
      },
    ],
  }),
