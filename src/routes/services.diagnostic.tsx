...
export const Route = createFileRoute("/services/diagnostic")({
  head: () => ({
    meta: [
      { title: "Правовая диагностика ситуации — STATUS SVOBODY" },
      {
        name: "description",
        content:
          "Стартовая услуга бренда: 90-минутный правовой разбор кейса с Юлией Арминой. Анализ долгов, договоров, имущества и БКИ — на выходе письменная стратегия и список первых шагов.",
      },
      { property: "og:title", content: "Правовая диагностика ситуации — STATUS SVOBODY" },
      {
        property: "og:description",
        content: "90 минут наедине с юристом: разбор документов, рисков и сценариев. Письменная стратегия с понятным первым шагом.",
      },
      { name: "twitter:title", content: "Правовая диагностика ситуации — STATUS SVOBODY" },
      {
        name: "twitter:description",
        content: "Разбор документов и рисков лично с Юлией Арминой. Письменная стратегия и первый шаг.",
      },
    ],
  }),
