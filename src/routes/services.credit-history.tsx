  ...
  head: () => ({
    meta: [
      { title: "Юридическое восстановление кредитной истории — STATUS SVOBODY" },
      {
        name: "description",
        content:
          "Долгосрочный правовой проект на 1,5–3 года: оспаривание некорректных записей в трёх БКИ по 218-ФЗ, формирование положительной истории и подготовка к ипотеке после банкротства.",
      },
      { property: "og:title", content: "Юридическое восстановление кредитной истории — STATUS SVOBODY" },
      {
        property: "og:description",
        content:
          "Системная работа с НБКИ, ОКБ и Скоринг-Бюро по 218-ФЗ. Возврат рейтинга и доступ к ипотеке после банкротства — пошагово, лично с Юлией Арминой.",
      },
      { name: "twitter:title", content: "Юридическое восстановление кредитной истории — STATUS SVOBODY" },
      {
        name: "twitter:description",
        content:
          "Оспаривание данных в трёх БКИ по 218-ФЗ и путь к ипотеке после банкротства.",
      },
    ],
  }),
