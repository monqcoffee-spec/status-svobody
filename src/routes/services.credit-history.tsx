...
export const Route = createFileRoute("/services/credit-history")({
  head: () => ({
    meta: [
      { title: "Восстановление кредитной истории — Статус Свободы" },
      {
        name: "description",
        content:
          "Алгоритм восстановления кредитного рейтинга за 1,5–3 года: чистка некорректных записей в трёх БКИ, выстраивание истории, путь к ипотеке.",
      },
      { property: "og:title", content: "Восстановление кредитной истории" },
      {
        property: "og:description",
        content:
          "Финансовый консультант помогает вернуть рейтинг в трёх БКИ и подготовиться к ипотеке.",
      },
    ],
  }),
