  ...
  head: () => ({
    meta: [
      { title: "STATUS SVOBODY — юридические решения для вашей свободы" },
      {
        name: "description",
        content:
          "Премиальный юридический консалтинг в Москве: личное сопровождение Юлии Арминой по финансам, долговым спорам и кредитной истории. Без посредников и колл-центров.",
      },
      { property: "og:title", content: "STATUS SVOBODY — юридические решения для вашей свободы" },
      {
        property: "og:description",
        content:
          "Личное сопровождение основателем бренда: финансовые споры, долги, кредитная история. Москва, Цветной бульвар.",
      },
      { name: "twitter:title", content: "STATUS SVOBODY — юридические решения для вашей свободы" },
      {
        name: "twitter:description",
        content:
          "Личное юридическое сопровождение Юлии Арминой. Финансы, долги, кредитная история.",
      },
    ],
  }),
  component: IndexPage,
