  ...
  const tiers = [
    {
      ...
      sub: "Пошаговый план для самостоятельного исправления кредитной истории",
      price: "5 000 ₽",
      meta: "Включает 1 консультацию",
      features: ["Аудит отчётов в бюро кредитных историй", "Письменное заключение", "План действий"],
      highlight: false,
      art: iconTierBasic,
    },
    {
