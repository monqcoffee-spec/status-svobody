...
function Services() {
  const services = [
    { art: iconDispute, t: "Оспаривание данных в Бюро кредитных историй", d: "Оспариваем ошибки, ложные записи и незаконные долги в кредитной истории. Срок — до 30 дней. Повышаем кредитный рейтинг." },
