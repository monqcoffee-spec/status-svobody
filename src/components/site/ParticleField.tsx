...
/**
 * Lightweight canvas particle field — drifting cyan dots.
 * Used as ambient hero background. Respects prefers-reduced-motion.
 */
export function ParticleField({
  ...
  useEffect(() => {
    ...
    const resize = () => {
      ...
      const count = Math.floor((w * h) / (1400000 / density));
