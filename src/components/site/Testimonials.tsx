...
const REVIEWS: Review[] = [
  ...
  },
  {
    ...
    date: "Ноябрь 2024",
    text:
      "Экспресс-анализ БКИ за один день. Получила письменное заключение и пошаговый план. Сделала всё сама — кредитный рейтинг вырос на 120 пунктов за 4 месяца.",
  },
  {
    name: "Андрей В.",
    rating: 5,
    date: "Октябрь 2024",
    text:
      "Премиум-сопровождение под ключ. Решены вопросы с ФССП, удалены устаревшие записи, восстановлена репутация заёмщика. Это не услуга — это статус.",
  },
];
