...
const ITEMS: Item[] = [
  {
    ...
    a: "Да. 218-ФЗ «О кредитных историях» прямо разрешает субъекту КИ оспаривать недостоверные записи в бюро кредитных историй. Мы работаем строго в рамках закона: подаём заявления, жалобы, при необходимости — иск.",
  },
  {
