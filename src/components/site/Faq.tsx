...
const ITEMS: Item[] = [
  {
    ...
    a: "Да. 218-ФЗ «О кредитных историях» прямо разрешает субъекту кредитной истории оспаривать недостоверные записи в бюро кредитных историй. Мы работаем строго в рамках закона: подаём заявления, жалобы, при необходимости — иск.",
  },
  {
    q: "Сколько времени занимает процесс?",
    a: "Оспаривание одной записи в бюро кредитных историй — до 30 дней. Комплексное восстановление кредитной истории и репутации — от 2 до 6 месяцев в зависимости от состояния Цифрового профиля.",
  },
  {
